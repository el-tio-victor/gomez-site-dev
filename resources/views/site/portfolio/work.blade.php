...
@section('header')
    ...
    @component('site.partials._header', [
        'class_flex_childs' => 'flex-column justify-content-center pt-3 align-items-center',
        'class_header_video' => $video_class,
    ])
        @if (MyHelpers::typeFile($img_src) === 'image')
            <div class="col-12 d-flex justify-content-center">
                <div class="col-11 col-md-7 col-lg-6 p-0 mt-4">
        ...
        <div class=" col-9 col-md-6 col-lg-4 d-flex justify-content-center align-items-center bg-white wrapper-work-title">
...
@section('content')
    <section class="  work-info">
        <div
            class=' col-12 col-lg-10 p-0  m-auto d-flex flex-column flex-md-row justify-content-around align-items-start work-info-wrapper'>

            @component('site.portfolio.partials._work_techs', ['work_techs' => $work_techs])
            @endcomponent
            <div class="col-12  col-md-6 pt-3 bg-white work-detail ">
                <h3>
                    <span class="">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 512 512">
                            <path
                                d="M352 32l-160 160h-96l-96 128c0 0 101.708-28.326 161.033-15.042l-161.033 207.042 210.951-164.072c29.419 67.327-18.951 164.072-18.951 164.072l128-96v-96l160-160 32-160-160 32z">
                            </path>
                        </svg>
                    </span>
                    <span> El reto</span>
