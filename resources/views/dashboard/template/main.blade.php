...
<head>
  ...
  <title>Panel de Administración | Gomez-Site.mx</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>g-s.</b>mx</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>gomez-site</b>.mx</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="/images/page/g-s.svg" class="img-circle" alt="User Image">
        </div>
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        <div class=' col panel-cont'>
            <section class=" d-flex justify-content-center border  main">
                <div class="  ">
